...
from .models import Product, Category, ProductDetail, Impression, UserProfile, Cart, CartItem, Order, OrderItem
import json
        ...
        if request.is_ajax():
            if form.is_valid():
                ...
                try:
                    ...
                    Message = EmailMessage(email_subject, email_body, from_email='MBASQL <hello@mbasql.com>',to=[email], bcc=['salemmarafi@gmail.com'],reply_to=['hello@mbasql.com'])
